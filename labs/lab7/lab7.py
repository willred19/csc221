...
from lab7_solution import count_letters, reverse_string, is_palindrome
...
def test_count_letters():
    assert count_letters("little","t")== 2
    assert count_letters("little", "l")== 2
    assert count_letters("little", "w")== 0
